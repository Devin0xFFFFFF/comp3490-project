...
namespace Common.Unity.Mathematics
{
	public static class MathConverter
	{
        ...
        public static Vector3 ToVector3(Common.Mathematics.LinearAlgebra.Vector3d v)
		{
		...
		public static Common.Mathematics.LinearAlgebra.Vector3d ToVector3d(Vector3 v)
		{
			return new Common.Mathematics.LinearAlgebra.Vector3d(v.x, v.y, v.z);
		}
        ...
        public static Vector4 ToVector4(Common.Mathematics.LinearAlgebra.Vector3d v)
        {
        ...
        public static IList<Vector3> ToVector3(IList<Common.Mathematics.LinearAlgebra.Vector3d> list)
        {
            Vector3[] vectors = new Vector3[list.Count];
            for (int i = 0; i < list.Count; i++)
        ...
        public static IList<Common.Mathematics.LinearAlgebra.Vector3d> ToVector3d(IList<Vector3> list)
        {
            Common.Mathematics.LinearAlgebra.Vector3d[] vectors = new Common.Mathematics.LinearAlgebra.Vector3d[list.Count];
            for (int i = 0; i < list.Count; i++)
                vectors[i] = new Common.Mathematics.LinearAlgebra.Vector3d(list[i].x, list[i].y, list[i].z);
