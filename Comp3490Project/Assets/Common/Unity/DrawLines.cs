...
namespace Common.Unity.Drawing
{
    ...
    public static class DrawLines
    {
        ...
        public static void DrawVertices(LINE_MODE mode, Camera camera, Color color, IList<Common.Mathematics.LinearAlgebra.Vector3d> vertices, IList<int> indices, Matrix4x4d localToWorld)
        {
            if (camera == null || vertices == null || indices == null) return;
